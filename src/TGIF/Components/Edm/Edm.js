...
const Edm = () => {
    return (
    <>
        <div className='edmMainContainer'>
            <div className='titleContainer'>
                    <h2>
                        Finance Strategy Template for CFOs and Finance Leaders
                    </h2>
            </div>
            <div className='edmbothContainer'>
                ...
                <div className='thumbnailContainer'>
                        <img src='https://resource.itbusinesstoday.com/whitepapers/31002-Gartner-CPL-Q4-PFG-1.PNG' alt='thumbnail' ></img>
                </div>
